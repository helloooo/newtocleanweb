...
function HomePage() {
  return (
    <div className="text-white font-sans">
      ...
      {/* Hero Section */}
      <section className="container bg-purple-700 py-20 mt-8 mb-16 rounded-3xl mx-auto p-8 flex items-center justify-between">
      ...
      <section className="container bg-purple-600 py-10 mt-8 mb-6 rounded-3xl mx-auto p-8 flex flex-col items-center justify-center">
      ...
      <section className="bg-purple-600 mt-5 py-16">
        <div className="container mx-auto">
      ...
      <section className="container bg-purple-600 py-10 mt-8 mb-6 rounded-3xl mx-auto p-8 flex flex-col items-center justify-center">
        <div className="container mx-auto flex flex-col justify-center items-center">
          <p className="mb-4 text-4xl font-bold">BECOME SERVICE PROVIDER </p>
          <p className="text-xl">Get more clients Earn more</p>
          <p className="mt-8 text-4xl font-bold">Download App</p>
      ...
      <footer className="bg-purple-800 py-8">
        <div className="container mx-auto text-center">
          <p>&copy; 2018 www.toclean.com.au All rights reserved.</p>
